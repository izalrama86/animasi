          ...
          Burst = (function (superClass) {
            ...
            Burst.prototype.run = function (o) {
              ...
              if (o != null && Object.keys(o).length) {
                if (
                  o.count ||
                  ((ref = o.childOptions) != null ? ref.count : void 0)
                ) {
                ...
                while (len--) {
                  ...
                  if (
                    ((ref1 = o.childOptions) != null ? ref1.angle : void 0) ==
                      null &&
                    o.angleShift == null
                  ) {
              ...
              if (this.props.randomAngle || this.props.randomRadius) {
                ...
                while (len--) {
                  ...
                  this.props.randomAngle &&
                    tr.setProp({
                      angleShift: this.generateRandomAngle(),
                    });
                  this.props.randomRadius &&
                    tr.setProp({
              ...
              for (
                ...
                option.isDrawLess =
                  ...
                  option.isTweenLess =
                    true;
                this.props.randomAngle &&
                  (option.angleShift = this.generateRandomAngle());
                this.props.randomRadius &&
                  (option.radiusScale = this.generateRandomRadius());
            ...
            Burst.prototype.addBitOptions = function () {
              ...
              this.degreeCnt =
                this.props.degree % 360 === 0 ? points : points - 1 || 1;
              ...
              for (i = j = 0, len1 = ref.length; j < len1; i = ++j) {
                ...
                transit.o.x = this.getDeltaFromPoints(
                  "x",
                  pointStart,
                  pointEnd
                );
                transit.o.y = this.getDeltaFromPoints(
                  "y",
                  pointStart,
                  pointEnd
                );
            ...
            Burst.prototype.getDeltaFromPoints = function (
              key,
              pointStart,
              pointEnd
            ) {
            ...
            Burst.prototype.isNeedsTransform = function () {
              return (
                this.isPropChanged("shiftX") ||
                this.isPropChanged("shiftY") ||
                this.isPropChanged("angle")
              );
            };
            ...
            Burst.prototype.getPropByMod = function (o) {
              var prop, ref;
              prop =
                (ref = o.from || this.o.childOptions) != null
                  ? ref[o.key]
                  : void 0;
            ...
            Burst.prototype.generateRandomRadius = function (i) {
              ...
              randdomness = randomness > 1 ? 1 : randomness < 0 ? 0 : void 0;
              start = randomness ? (1 - randomness) * 100 : (1 - 0.5) * 100;
              return this.h.rand(start, 100) / 100;
            };

            Burst.prototype.then = function (o) {
              this.h.error(
                'Burst\'s "then" method is under consideration, you can vote for it in github repo issues'
              );
              return this;
            };
          ...
          (function (global) {
            ...
            BezierEasing = (function () {
              ...
              BezierEasing.prototype.generate = function (mX1, mY1, mX2, mY2) {
                ...
                float32ArraySupported =
                  indexOf.call(global, "Float32Array") >= 0;
                A = function (aA1, aA2) {
                ...
                mSampleValues = !float32ArraySupported
        ...
        function (require, module, exports) {
          ...
          PathEasing = (function () {
            ...
            PathEasing.prototype._findBounds = function (array, p) {
              ...
              for (
                i = j = ref = this._boundsStartIndex, ref1 = loopEnd;
            ...
            PathEasing.prototype._checkIfBoundsCloseEnough = function (
              p,
              bounds
            ) {
              var point, y;
            ...
            PathEasing.prototype._checkIfPointCloseEnough = function (
              p,
              point
            ) {
            ...
            PathEasing.prototype._approximate = function (start, end, p) {
              ...
              percentP =
                (p - start.point.x / this._rect) / (deltaP / this._rect);
              return start.length + percentP * (end.length - start.length);
            };

            PathEasing.prototype._findApproximate = function (
              p,
              start,
              end,
              approximateMax
            ...
            PathEasing.prototype._normalizePath = function (path) {
              ...
              return (normalizedPath = this._joinNormalizedPath(
                commands,
                points
              ));
            };

            PathEasing.prototype._joinNormalizedPath = function (
              commands,
              points
            ) {
      ...
      6: [
        function (require, module, exports) {
          ...
          Helpers = (function () {
            ...
            Helpers.prototype.setPrefixedStyle = function (
              el,
              name,
              value,
              isIt
            ...
            Helpers.prototype.makeColorObj = function (color) {
              var alpha,
                ...
                rgbColor;
              if (color[0] === "#") {
                result = /^#?([a-f\d]{1,2})([a-f\d]{1,2})([a-f\d]{1,2})$/i.exec(
                  color
                );
                colorObj = {};
                if (result) {
                  r =
                    result[1].length === 2 ? result[1] : result[1] + result[1];
                  g =
                    result[2].length === 2 ? result[2] : result[2] + result[2];
                  b =
                    result[3].length === 2 ? result[3] : result[3] + result[3];
                  colorObj = {
                    r: parseInt(r, 16),
                    g: parseInt(g, 16),
                    b: parseInt(b, 16),
              ...
              if (color[0] !== "#") {
                ...
                if (!isRgb) {
                  rgbColor = !this.shortColors[color]
                    ? ((this.div.style.color = color),
                      this.computedStyle(this.div).color)
                    : this.shortColors[color];
                }
                regexString1 = "^rgba?\\((\\d{1,3}),\\s?(\\d{1,3}),";
                regexString2 = "\\s?(\\d{1,3}),?\\s?(\\d{1}|0?\\.\\d{1,})?\\)$";
                result = new RegExp(regexString1 + regexString2, "gi").exec(
                  rgbColor
                );
                colorObj = {};
            ...
            Helpers.prototype.parseStagger = function (string, index) {
              ...
              value =
                splittedValue.length > 3
                  ? ((base = this.parseUnit(
                      this.parseIfRand(splittedValue[1])
                    )),
                    splittedValue[3])
                  : ((base = this.parseUnit(0)), splittedValue[1]);
            ...
            Helpers.prototype.delta = function (start, end) {
              ...
              type2 = typeof end;
              isType1 =
                type1 === "string" || (type1 === "number" && !isNaN(start));
              isType2 =
                type2 === "string" || (type2 === "number" && !isNaN(end));
              if (!isType1 || !isType2) {
                this.error(
        ...
        function (require, module, exports) {
          ...
          MotionPath = (function () {
            ...
            MotionPath.prototype.postVars = function () {
              ...
              this.slicedLen =
                this.len * (this.props.pathEnd - this.props.pathStart);
            ...
            MotionPath.prototype.createFilter = function () {
              ...
              return (this.el.style[h.prefix.css + "filter"] =
                "url(#" + this.filterID + ")");
            };
            ...
            MotionPath.prototype.getScaler = function () {
              ...
              size.height =
                end.y >= start.y ? end.y - start.y : start.y - end.y;
            ...
            MotionPath.prototype.createTween = function () {
              this.tween = new Tween({
                ...
                onStart: (function (_this) {
                  return function () {
                    var ref;
                    return (ref = _this.props.onStart) != null
                      ? ref.apply(_this)
                      : void 0;
                  };
                })(this),
                onComplete: (function (_this) {
                  return function () {
                    ...
                    return (ref = _this.props.onComplete) != null
                      ? ref.apply(_this)
                      : void 0;
                  };
                })(this),
                ...
                onFirstUpdateBackward: (function (_this) {
                  return function () {
                    return (
                      _this.history.length > 1 &&
                      _this.tuneOptions(_this.history[0])
                    );
                  };
                })(this),
              });
            ...
            MotionPath.prototype.startTween = function () {
              return setTimeout(
                (function (_this) {
                  return function () {
                    var ref;
                    return (ref = _this.timeline) != null
                      ? ref.start()
                      : void 0;
                  };
                })(this),
            ...
            MotionPath.prototype._getCurrentAngle = function (point, len, p) {
              ...
              isTransformFunOrigin =
                typeof this.props.transformOrigin === "function";
              if (
                this.props.isAngle ||
                this.props.angleOffset != null ||
                isTransformFunOrigin
              ) {
                ...
                if (typeof this.props.angleOffset !== "function") {
                  ...
                  return (this.angle = this.props.angleOffset.call(
                    this,
                    this.angle,
                    p
                  ));
            ...
            MotionPath.prototype._setTransformOrigin = function (p) {
              ...
              if (this.props.transformOrigin) {
                isTransformFunOrigin =
                  typeof this.props.transformOrigin === "function";
                tOrigin = !isTransformFunOrigin
                  ? this.props.transformOrigin
                  : this.props.transformOrigin(this.angle, p);
            ...
            MotionPath.prototype.then = function (o) {
              ...
              for (key in prevOptions) {
                ...
                if (
                  (!h.callbacksMap[key] && !h.tweenOptionMap[key]) ||
                  key === "duration"
                ) {
                  if (o[key] == null) {
                    o[key] = value;
            ...
            MotionPath.prototype.angToCoords = function (angle) {
              ...
              x = Math.cos(radAngle);
              y = Math.sin(radAngle);
              x = x < 0 ? Math.max(x, -0.7) : Math.min(x, 0.7);
              y = y < 0 ? Math.max(y, -0.7) : Math.min(y, 0.7);
              return {
                x: x * 1.428571429,
                y: y * 1.428571429,
              };
        ...
        function (require, module, exports) {
          (function (root) {
            ...
            if (root.performance.now == null) {
              offset = (
                (ref = root.performance) != null
                  ? (ref1 = ref.timing) != null
                    ? ref1.navigationStart
                    : void 0
                  : void 0
              )
          ...
          (function () {
            ...
            while (i < vendors.length && !w.requestAnimationFrame) {
              ...
              w.cancelAnimationFrame =
                cancel || w[vp + "CancelRequestAnimationFrame"];
              ++i;
            }
            isOldBrowser = !w.requestAnimationFrame || !w.cancelAnimationFrame;
            if (
              /iP(ad|hone|od).*OS 6/.test(w.navigator.userAgent) ||
              isOldBrowser
            ) {
              lastTime = 0;
          ...
          Bit = (function () {
            ...
            Bit.prototype.castStrokeDash = function (name) {
              ...
              if (typeof this.props[name] === "object") {
                stroke =
                  this.props[name].unit === "%"
                    ? this.castPercent(this.props[name].value)
            ...
            Bit.prototype.getLength = function () {
              var ref;
              if (
                ((ref = this.el) != null ? ref.getTotalLength : void 0) !=
                  null &&
        ...
        function (require, module, exports) {
          ...
          Cross = (function (superClass) {
            ...
            Cross.prototype.draw = function () {
              ...
              line1 =
                "M" + x1 + "," + this.props.y + " L" + x2 + "," + this.props.y;
              y1 = this.props.y - radiusY;
              y2 = this.props.y + radiusY;
              line2 =
                "M" + this.props.x + "," + y1 + " L" + this.props.x + "," + y2;
              d = line1 + " " + line2;
              return this.setAttr({
                d: d,
              });
        ...
        function (require, module, exports) {
          ...
          Spriter = (function () {
            ...
            Spriter.prototype._createTween = function () {
              this._tween = new Tween({
                ...
                onStart: (function (_this) {
                  return function () {
                    var base;
                    return typeof (base = _this._props).onStart === "function"
                      ? base.onStart()
                      : void 0;
                  };
                })(this),
                onComplete: (function (_this) {
                  return function () {
                    var base;
                    return typeof (base = _this._props).onComplete ===
                      "function"
                      ? base.onComplete()
                      : void 0;
                  };
            ...
            Spriter.prototype._setProgress = function (p) {
              ...
              return typeof (base = this._props).onUpdate === "function"
                ? base.onUpdate(p)
                : void 0;
            };
        ...
        function (require, module, exports) {
          ...
          Stagger = (function () {
            ...
            Stagger.prototype.init = function (options, Module) {
              ...
              count = this._getChildQuantity(
                options.quantifier || "el",
                options
              );
        ...
        function (require, module, exports) {
          ...
          Swirl = (function (superClass) {
            ...
            Swirl.prototype.extendDefaults = function () {
              ...
              this.props.angleShift = this.h.parseIfRand(
                this.o.angleShift || 0
              );
              return (this.props.radiusScale = this.h.parseIfRand(
                this.o.radiusScale
              ));
            };
            ...
            Swirl.prototype.setProgress = function (progress) {
              ...
              point = this.h.getRadialPoint({
                angle: angle,
                radius:
                  this.positionDelta.radius * progress * this.props.radiusScale,
                center: {
            ...
            Swirl.prototype.generateSwirl = function () {
              ...
              return (this.props.swirlFrequency = this.h.parseIfRand(
                this.o.swirlFrequency
              ));
            };
            ...
            Swirl.prototype.getSwirl = function (progress) {
              return (
                this.props.signRand *
                this.props.swirlSize *
                Math.sin(this.props.swirlFrequency * progress)
              );
            };
        ...
        function (require, module, exports) {
          ...
          Transit = (function (superClass) {
            ...
            Transit.prototype.drawEl = function () {
              ...
              if (!this.isForeign) {
                ...
                if (this.isNeedsTransform()) {
                  return this.h.setPrefixedStyle(
                    this.el,
                    "transform",
                    this.fillTransform()
                  );
            ...
            Transit.prototype.calcSize = function () {
              ...
              switch (
                typeof (base = this.props.easing).toLowerCase === "function"
                  ? base.toLowerCase()
                  : void 0
              ) {
                case "elastic.out":
            ...
            Transit.prototype.getRadiusSize = function (o) {
              if (this.deltas[o.key] != null) {
                return Math.max(
                  Math.abs(this.deltas[o.key].end),
                  Math.abs(this.deltas[o.key].start)
                );
            ...
            Transit.prototype.setProgress = function (progress, isShow) {
              ...
              this.progress =
                progress < 0 || !progress ? 0 : progress > 1 ? 1 : progress;
                    ...
                    switch (value.type) {
                      case "array":
                        ...
                        for (i = k = 0, len1 = ref.length; k < len1; i = ++k) {
                          item = ref[i];
                          dash =
                            value.start[i].value + item.value * this.progress;
                          stroke.push({
                            value: dash,
                            unit: item.unit,
                          });
                      ...
                      case "unit":
                        ...
                        return (
                          "" +
                          (value.start.value + value.delta * progress) +
                          units
                        );
                      case "color":
                        r = parseInt(
                          value.start.r + value.delta.r * progress,
                          10
                        );
                        g = parseInt(
                          value.start.g + value.delta.g * progress,
                          10
                        );
                        b = parseInt(
                          value.start.b + value.delta.b * progress,
                          10
                        );
                        a = parseInt(
                          value.start.a + value.delta.a * progress,
                          10
                        );
                        return "rgba(" + r + "," + g + "," + b + "," + a + ")";
                    }
            ...
            Transit.prototype.extendDefaults = function (o) {
              ...
              while (len--) {
                ...
                if (o) {
                  ...
                  optionsValue =
                    this.o[key] != null ? this.o[key] : defaultsValue;
                }
                if (!this.isDelta(optionsValue)) {
                  if (typeof optionsValue === "string") {
                    if (optionsValue.match(/stagger/)) {
                      optionsValue = this.h.parseStagger(
                        optionsValue,
                        this.index
                      );
                    }
            ...
            Transit.prototype.isDelta = function (optionsValue) {
              ...
              return !(
                !isObject ||
                this.h.isArray(optionsValue) ||
                h.isDOM(optionsValue)
              );
            };
            ...
            Transit.prototype.getDelta = function (key, optionsValue) {
              ...
              if ((key === "x" || key === "y") && !this.o.ctx) {
                this.h.warn(
                  "Consider to animate shiftX/shiftY properties instead of x/y, as it would be much more performant",
                  optionsValue
                );
              }
            ...
            Transit.prototype.mergeThenOptions = function (start, end) {
              ...
              for (key in start) {
                value = start[key];
                if (
                  (!this.h.tweenOptionMap[key] && !this.h.callbacksMap[key]) ||
                  key === "duration"
                ) {
                  o[key] = value;
                } else {
              ...
              return (this.tween = new Tween({
                ...
                onReverseComplete: (function (_this) {
                  return function () {
                    ...
                    return (ref = _this.props.onReverseComplete) != null
                      ? ref.apply(_this)
                      : void 0;
                  };
                })(this),
                  ...
                  while (len--) {
                    ...
                    if (h.callbacksMap[key] || h.tweenOptionMap[key]) {
                      h.warn(
                        'the property "' +
                          key +
                          '" property can not be overridden on run with "then" chain yet'
                      );
                      delete o[key];
                    }
                  }
      ...
      24: [
        function (require, module, exports) {
          ...
          Timeline = (function () {
            ...
            Timeline.prototype.appendTimeline = function (
              timeline,
              index,
              time
            ) {
            ...
            Timeline.prototype._recalcTimelineDuration = function (timeline) {
              var timelineTime;
              timelineTime =
                timeline.props.repeatTime + (timeline.props.shiftTime || 0);
              this.props.time = Math.max(timelineTime, this.props.time);
              this.props.repeatTime =
                (this.props.time + this.props.delay) * (this.props.repeat + 1);
              this.props.shiftedRepeatTime =
                this.props.repeatTime + (this.props.shiftTime || 0);
            ...
            Timeline.prototype._updateTimelines = function (time, isGrow) {
              ...
              elapsed =
                (time - startPoint) % (this.props.delay + this.props.time);
              timeToTimelines =
                time === this.props.endTime
                  ? this.props.endTime
                  : startPoint + elapsed >= this.props.startTime
                  ? time >= this.props.endTime
                    ? this.props.endTime
                    : startPoint + elapsed
                  : time > this.props.startTime + this.props.time
                  ? this.props.startTime + this.props.time
                  : null;
            ...
            Timeline.prototype._checkCallbacks = function (time) {
              ...
              if (time >= this.props.startTime && time < this.props.endTime) {
                if (typeof this.onUpdate === "function") {
                  this.onUpdate(
                    (time - this.props.startTime) / this.props.repeatTime
                  );
                }
              }
            ...
            Timeline.prototype.setProgress = function (progress) {
              ...
              return this.update(
                this.props.startTime + progress * this.props.repeatTime
              );
            };
            ...
            Timeline.prototype.getDimentions = function (time) {
              ...
              this.props.startTime =
                time + this.props.delay + (this.props.shiftTime || 0);
              this.props.endTime =
                this.props.startTime + this.props.shiftedRepeatTime;
        ...
        function (require, module, exports) {
          ...
          Tween = (function () {
            ...
            Tween.prototype.calcDimentions = function () {
              ...
              return (this.props.repeatTime =
                this.props.time * (this.props.repeat + 1));
            };
            ...
            Tween.prototype.extendDefaults = function () {
              ...
              this.props.easing = easing.parseEasing(
                this.o.easing || this.defaults.easing
              );
              return (this.onUpdate = this.props.onUpdate);
            };
            ...
            Tween.prototype.start = function (time) {
              ...
              this.props.startTime =
                time + this.props.delay + (this.props.shiftTime || 0);
              this.props.endTime =
                this.props.startTime + this.props.repeatTime - this.props.delay;
              return this;
            };
            ...
            Tween.prototype._updateInActiveArea = function (time) {
              ...
              startPoint = this.props.startTime - this.props.delay;
              elapsed =
                (time - startPoint) % (this.props.delay + this.props.duration);
              cnt = Math.floor(
                (time - startPoint) / (this.props.delay + this.props.duration)
              );
              if (startPoint + elapsed >= this.props.startTime) {
                elapsed2 =
                  ...
                  (this.props.delay + this.props.duration);
        ...
        function (require, module, exports) {
          ...
          Tweener = (function () {
            ...
            Tweener.prototype.remove = function (tween) {
              var index;
              index =
                typeof tween === "number" ? tween : this.tweens.indexOf(tween);
              if (index !== -1) {
                      ...
                      (function (proto) {
                        ...
                        (function (listener) {
                          ...
                          if (proto.prototype.addEventListener) {
                            ...
                            return (proto.prototype.attachEvent =
                              wrappedListener);
                          }
                        })(listener);
                        remover =
